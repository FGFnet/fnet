...
export default function Banner() {
  ...
  return (
    <div style={{ height: 300, position: 'relative', width: '100vw' }}>
      ...
      <div
        style={{ display: 'flex', alignItems: 'center', justifyContent: 'start', height: '85%', marginLeft: '17%' }}
        className={style.ani}
      >
        {breakPoint && (
          <img
            src={Logo}
            alt="logo"
            style={{ width: '15%', position: 'relative', marginRight: 60, transform: `rotate(25deg)` }}
          />
        )}
        <div>
          <div style={{ fontSize: 30, fontWeight: 'bold', color: Colors.primary, position: 'relative' }}>
            FRESHMAN GUIDE
          </div>
          <div
            style={{
