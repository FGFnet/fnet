...
from ..serializers import CheckCommentSerializer, CreateNoticeSerializer, EditNoticeSerializer, NoticeSerializer
...
class CommentAdminAPI(CSRFExemptAPIView):
    def put(self, request):
        ...
        """
        serializer = CheckCommentSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        data = serializer.data
